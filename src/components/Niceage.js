        ...
        <div className="container dark-mode position-relative zindex-2 py-5 mb-4 mb-sm-5">
          <div className="row pb-5 mb-2 mb-sm-0 mb-lg-3">
            <div className="col-lg-10 col-xl-9">
              <h1 className="display-2 pb-2 pb-sm-3">Клуб «Приятный возраст» (55+)</h1>
              <p className='display-5'>Наш Мультиформатный центр знает, как важны для каждого из нас бабушки и дедушки.</p>
      ...
      <section className="container position-relative zindex-3" style={{marginTop: '-135px'}}>
        <div className="rounded-5 overflow-hidden"> 
          <div className="jarallax ratio ratio-16x9" dataJarallax dataSpeed="0.6">
            <div className="jarallax-img" style={{backgroundImage: 'url(assets/img/landing/corporate/niceage.jpg)'}}></div>
          </div>
        </div>
