...
export default class Home extends Component {
  ...
  render() {
    ...
    <section className="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        ...
        <div className="col"><a className="card card-hover h-100 border-0 bg-secondary rounded-1 text-decoration-none overflow-hidden" href="/publications">
            ...
            <div className="card-body pb-3">
                ...
                <p className="mb-0 fs-lg">
                В нашем Центре развития «Форматы» 1 раз в квартал проходит День открытых дверей (мастер-классы, конкурсы, участие с родителями, сладкие подарки).
    ...
    <h2 className="h1 text-center pt-2 pt-sm-3 pt-md-4 pt-xl-5 mt-lg-2 mt-xl-1">Компании, которые нам доверяют</h2>
        ...
        <div className="col">
            <img className="d-block mx-auto" src="assets/img/brands/AgriBrasil.jpg" width="220" alt="AgriBrasil"/>
        </div>
        <div className="col">
            <img className="d-block d-dark-mode-none mx-auto" src="assets/img/brands/NassauGroup.jpg" width="220" alt="NassauGroup"/>
            <img className="d-none d-dark-mode-block mx-auto" src="assets/img/brands/SeaVew.jpg" width="220" alt="SeaVew"/>
        </div>
        <div className="col">
            <img className="d-block d-dark-mode-none mx-auto" src="assets/img/brands/RegenBogen.jpg" width="220" alt="RegenBogen"/>
            <img className="d-none d-dark-mode-block mx-auto" src="assets/img/brands/starcraft-light.svg" width="220" alt="Starcraft"/>
        </div>
        <div className="col">
            <img className="d-block mx-auto" src="assets/img/brands/Travel72.jpg" width="220" alt="Travel72"/>
        </div>
        <div className="col">
            <img className="d-block d-dark-mode-none mx-auto" src="assets/img/brands/GemoTest.jpg" width="220" alt="GemoTest"/>
            <img className="d-none d-dark-mode-block mx-auto" src="assets/img/brands/Muzakalka.jpg" width="220" alt="Muzakalka"/>
        </div>
        <div className="col">
            <img className="d-block mx-auto" src="assets/img/brands/Mebelier72.jpeg" width="220" alt="Mebelier72"/>
        </div>
        <div className="col">
    ...
    <section className="bg-secondary py-5">
        ...
        <div className="row align-items-center py-3 py-sm-4 py-lg-5 mb-3 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4" dataAos="fade-up" dataAosDuration="600" dataAosOffset="280" dataDisableParallaxDown="md">
            ...
            <div className="pe-md-4 pe-lg-0">
                ...
                Успех компании обеспечивает квалифицированный персонал, командная работа и грамотно выстроенные бизнес-процессы в ней. 
                Особую роль мы как руководители в последнее время уделяем развитию навыков сотрудников, мотивации и развития дополнительных компетенций персонала.
                <br/>У каждого члена команды есть семья и они тоже желают развиваться и быть успешными. 
                Наша команда предлагает комплексный подход к развитию навыков сотрудников и их членов семьи и как следствие увеличение производительности, вовлеченности на работе и увеличение их лояльности к компании.
                </p>
        ...
        <div className="row align-items-center py-3 py-sm-4 py-lg-5 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4" dataAos="fade-up" dataAosDuration="600" dataAosOffset="280" dataDisableParallaxDown="md">
            ...
            <div className="pe-md-4 pe-lg-0">
                ...
                <a className="btn" style={{backgroundColor: '#004655'}} href="/">Заказать бесплатную консультацию</a>
            </div>
            </div>
        </div>
        </div>
    ...
    <section className="bg-dark dark-mode position-relative pb-5 pb-lg-0 pt-md-2 pt-lg-4 pt-xl-5">
        ...
        <div className="row pb-2 pb-lg-0 pt-1 pt-sm-4">
            ...
            <a className="btn btn-outline-primary d-none d-md-inline-flex"
            //  style={{backgroundColor: '#004655'}} 
            ...
            <div className="ps-md-4 ps-lg-0">
                ...
                <div className="accordion-item mb-n3 mb-lg-n2 mb-xl-1">
                    ...
                    Английский язык, Рисование/лепка, Шахматы, Музыкальное направление, Профориентация, Полезные каникулы
                    </div>
                    </div>
                </div>
                <div className="accordion-item mb-n3 mb-lg-n2 mb-xl-1">
                    ...
                    <div className="accordion-body">
                    Семейный коучинг, Личностный рост, Управленческий коучинг, Женский клуб Women_art_trick, Клуб «Приятный возраст», Психологический туризм
                    </div>
                    </div>
                </div>
                <div className="accordion-item mb-n3 mb-lg-n2 mb-xl-1">
                    ...
                    <div className="accordion-body">
                      Групповой Коуч, Командный Коуч, Корпоративный Коуч, Групповое Тестирование, Бизнес Тренинги
                    </div>
                    </div>
                </div>
                {/* <div className="accordion-item mb-n3 mb-lg-n2 mb-xl-1">
        ...
        <div className="text-center d-md-none mt-4">
            <a className="btn btn-outline-primary" href="/aboutus"> Подробнее о «Форматы»</a></div>
        </div>
        {/* Shapes*/}
    ...
    <section className="container pt-5 mt-md-2 mt-lg-3 mt-xl-4 mt-xxl-5">
        ...
        <div className="col-sm-6 col-md-4">
            ...
            <div className="position-absolute p-1 top-0 start-0 w-100 h-100 opacity-0">
                <div className="bg-dark position-absolute top-0 start-0 w-100 h-100 opacity-50"></div>
                <div className="card-body d-flex flex-column justify-content-end dark-mode h-100 position-relative zindex-2 text-center">
                <h3 className="h5 mb-1"> Георгий Баев</h3>
                <p className="mb-3">Преподователь Шахмат и Шашек</p>
        ...
        <div className="col-sm-6 col-md-4">
            ...
            <div className="position-absolute p-1 top-0 start-0 w-100 h-100 opacity-0">
                <div className="bg-dark position-absolute top-0 start-0 w-100 h-100 opacity-50"></div>
                <div className="card-body d-flex flex-column justify-content-end dark-mode h-100 position-relative zindex-2 text-center">
                <h3 className="h5 mb-1">Татьяна Викторовна</h3>
                <p className="mb-3">Учитель Рисования и Лепки</p>
        ...
        <div className="col-sm-6 col-md-4">
            ...
            <div className="position-absolute p-1 top-0 start-0 w-100 h-100 opacity-0">
                <div className="bg-dark position-absolute top-0 start-0 w-100 h-100 opacity-50"></div>
                <div className="card-body d-flex flex-column justify-content-end dark-mode h-100 position-relative zindex-2 text-center">
                <h3 className="h5 mb-1">who</h3>
                <p className="mb-3">who who</p>
                <div className="d-flex justify-content-center"><a className="btn btn-icon btn-sm btn-light btn-instagram rounded-circle mx-2" href="/"><i className="ai-instagram"></i></a><a className="btn btn-icon btn-sm btn-light btn-facebook rounded-circle mx-2" href="/"><i className="ai-facebook"></i></a><a className="btn btn-icon btn-sm btn-light btn-linkedin rounded-circle mx-2" href="/"><i className="ai-linkedin"></i></a></div>
                </div>
            </div>
            </div>
    ...
    <section className="container py-5 mb-sm-2 mb-md-0 my-lg-3 my-xl-4 my-xxl-5">
        ...
        <div className="col-lg-6 pb-3 mb-2 mb-sm-3">
            <a className="card h-100 border-0 rounded-1 overflow-hidden text-decoration-none bg-size-cover bg-position-center" href="/" style={{maxWidth: '600px', minHeight: '300px', backgroundImage: 'url(assets/img/landing/corporate/blog-img.jpg)'}}>
            <div className="bg-dark position-absolute top-0 start-0 w-100 h-100 opacity-50"></div>
        ...
        <div className="col-lg-6">
            ...
            <article className="col">
                ...
                <h3 className="h4"><a href="/publications">Cобытие, которое состоялось в честь Дня Защиты Детей 1 июня 2023 года.</a></h3>
            ...
            <article className="col">
                <div className="pb-4 pt-2 pt-xl-3 ms-md-3 border-bottom">
                <h3 className="h4"><a href="/publications">Наши траектории Форматы</a></h3>
        ...
        <div className="text-end pb-md-4 pt-3 mt-2 mt-sm-3 mt-lg-4"><a className="d-inline-flex align-items-center fw-semibold text-decoration-none" href="/publications">Все новости<i className="ai-arrow-right fs-4 ms-2"></i></a></div>
    </section>
